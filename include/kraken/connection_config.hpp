...
struct ConnectionTimeouts {
    std::chrono::milliseconds connect_timeout{10000};  ///< Connection establishment timeout (default: 10s)
    std::chrono::milliseconds read_timeout{30000};     ///< Read operation timeout (default: 30s)
    std::chrono::milliseconds write_timeout{10000};    ///< Write operation timeout (default: 10s)
    std::chrono::seconds ping_interval{30};           ///< WebSocket ping interval (default: 30s)
    std::chrono::seconds pong_timeout{10};             ///< Pong response timeout (default: 10s)
};
